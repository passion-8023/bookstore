...
func (bs *BookStoreServer) createBookHandler(w http.ResponseWriter, request *http.Request)  {
...
func (bs *BookStoreServer) getBookHandler(w http.ResponseWriter, request *http.Request)  {
